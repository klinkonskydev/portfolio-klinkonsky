  ...
  return (
    <S.Footer id="projects">
      ...
      <div className="projects">
        <a
          href="https://klinkonskydev.github.io/cronometro/"
        ...
        <a
          href="https://klinkonskydev.github.io/DrumKit/"
          className="project-container"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          href="https://klinkonskydev.github.io/FlexPanel/"
          className="project-container"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          href="https://klinkonskydev.github.io/DEV.FINANCES-WITH-ROCKETSEAT/"
          className="project-container"
          target="_blank"
          rel="noreferrer"
        >
          ...
          <div className="legend">
            <p className="project-text" title="Maked with RocketSeat">
              DevFinance$ Project
            </p>
          </div>
        </a>
        ...
        <a
          href="https://klinkonskydev.github.io/Clock/"
          className="project-container"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          href="https://calculator-klinkonskydev.netlify.app/"
          className="project-container"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          href="https://klinkonskydev-jogodavelhav2.netlify.app/"
          className="project-container"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <a
          href="https://klinkonskydev-filmora.netlify.app/"
          className="project-container"
          target="_blank"
          rel="noreferrer"
        >
